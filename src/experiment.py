...
def run_backtesting(forecast_len=6, 
    ...
    if experiment_type=='benchmark':
        ...
        list_models=[ 'MLPForecast', 'NBEATS', 'NHiTS', 'RNN', 'MSTL' ,'CATBOOST', 'MSTL', 'SeasonalNaive', 'RF', 'LREGRESS', 'PatchTST','TimesNet', 'FEDformer']
        ...
        file_name=f'{exp_name}_{dataset}_{experiment_type}_{window_type}' 
        list_models=['MLPForecast', 'TimesNet']#'NHiTS',  'PatchTST', 'TimesNet'
        for window_size in [48, 96, 144, 192, 336, 384, 432]:
            for horizon in [48, 96, 192, 336]:
        ...
        for emb_type in [ "None", 'PosEmb', 'RotaryEmb']:#"None", 'PosEmb', 'RotaryEmb',
